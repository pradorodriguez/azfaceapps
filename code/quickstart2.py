...
IMAGE_BASE_URL = 'https://github.com/Azure-Samples/cognitive-services-sample-data-files/tree/bf60cfbaf344097cd8ba77384cd7ae5193d52947/Face/images'
...
woman_images = ["https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/Family1-Mom1.jpg?raw=true","https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/Family1-Mom2.jpg?raw=true"]
man_images = ["https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/Family1-Dad1.jpg?raw=true","https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/Family1-Dad2.jpg?raw=true"]
child_images = ["https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/Family1-Son1.jpg?raw=true","https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/Family1-Son2.jpg?raw=true"]
...
for image in woman_images:
    ...
    for face in detected_faces:
        ...
        print(f'Face {face.face_id} has left corner at ({face_rectangle.left}, {face_rectangle.top}), a width of {face_rectangle.width} pixels and height of {face_rectangle.height}.')        
        #area = face_rectangle.width * face_rectangle.height
        #print(f'The area of the bounding box is {area} pixels for face {face.face_id}.')
...
test_image = "https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/Face/images/identification1.jpg?raw=true"
